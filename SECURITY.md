...
A corpus of primary legal sources, not software. The security-shaped concern here is integrity: a document that does not faithfully reproduce its source, or a citation pointing somewhere other than where it claims. Report that here. Report a problem with the *harvesting tooling* to [id-law-kit](https://github.com/bakobo/id-law-kit/security).
